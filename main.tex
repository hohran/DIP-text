...
\graphicspath{{figures}{./obrazky-figures/}}
...
\projectinfo{
  ...
  title.cs={Analýza politik pro řízení přístupu},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Analysis of Access Control Policies}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Hranička},   % příjmení autora / author surname 
  ...
  supervisor.surname={Havlena},   % příjmení školitele / supervisor surname
...
\begin{document}
  ...
  \ifenglish
    ...
    \input{chapters/03_rego_formalization}
    \input{chapters/03_type_analysis}
    % \input{chapters/03_algorithm}
    \input{chapters/transformation}
    \input{chapters/transformation_new}
