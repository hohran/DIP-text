% \chapter{Analysis of Rego Policies}
%
% % In this chapter
% %% Theoretical decription of the analysis
% %% First SMT representation of policies
% %% Possible analysis and ways to encode them into SMT
%
% The Analysis of Rego Policies in this work operates on their encoding in SMT.
% We will first describe a procedure for transforming Rego into SMT and reason about the correctness and efficiency of its product.
% After that, section \todo{ref} will list possible analysis that such encoding enables.
...
Due to the complexity and expressiveness of the language, the description will start with covering simple scenarios and gradually introduce new constructs for this procedure to support.
