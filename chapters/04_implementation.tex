...
As the source code of the targetted Open Policy Agent \cite{opa:git} is written in the programming language \textsc{Go}, a lot of the infrastructure is already prepared when choosing this language as the base for \text{VeriRego}.
% Most importantly, this source co
